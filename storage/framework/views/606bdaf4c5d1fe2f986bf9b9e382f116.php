                                        ...
                                        <td class="min-width">
                                            <div class="lead">
                                                <div class="lead-image">
                                                    <img src="<?php echo e($venta->receta->imagen ? asset('storage/' . $venta->receta->imagen) : asset('images/recetas.jpg')); ?>"
                                                        alt="">
                                                </div>
                                                <div class="lead-text">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\20\Desktop\OTROS PROGRAMAS\PROYECTO PARA TECNOWEB\proyecto prueba 1\proyecto-tecnoweb_restaurante\sistema-web\resources\views/ventas/index.blade.php ENDPATH**/ ?>