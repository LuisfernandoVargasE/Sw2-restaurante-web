                    ...
                    <form action="<?php echo e(route('movimientos.store')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="insumo_id" id="insumo_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $insumos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insumo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($insumo->id); ?>" <?php echo e(old('insumo_id') == $insumo->id ? 'selected' : ''); ?>><?php echo e($insumo->nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="cantidad" class="form-label">Cantidad</label>
                            <input type="number" name="cantidad" id="cantidad" class="form-control" min="0.01" step="0.01" required value="<?php echo e(old('cantidad')); ?>">
                        </div>
                        <div class="mb-3">
                            ...
                            <select name="unidad_medida_id" id="unidad_medida_id" class="form-control">
                                ...
                                <?php $__currentLoopData = $unidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unidad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($unidad->id); ?>" <?php echo e(old('unidad_medida_id') == $unidad->id ? 'selected' : ''); ?>><?php echo e($unidad->nombre); ?> (<?php echo e($unidad->abreviatura); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tipo" id="tipo" class="form-control" required>
                                <option value="entrada" <?php echo e(old('tipo', 'entrada') == 'entrada' ? 'selected' : ''); ?>>Entrada</option>
                        ...
                        <div id="entrada-fields" style="display: none;">
                            <div class="mb-3">
                                ...
                                <input type="number" name="costo_compra" id="costo_compra" class="form-control" min="0" step="0.01" value="<?php echo e(old('costo_compra')); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="detalle_compra" id="detalle_compra" class="form-control" rows="2" placeholder="Ej: Compra semanal de verduras"><?php echo e(old('detalle_compra')); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="motivo" id="motivo" class="form-control" maxlength="100" required value="<?php echo e(old('motivo')); ?>">
                        </div>
                        <div class="mb-3">
                            <label for="fecha" class="form-label">Fecha</label>
                            <input type="date" name="fecha" id="fecha" class="form-control" required value="<?php echo e(old('fecha', date('Y-m-d'))); ?>">
                        </div>
                        <div class="text-end">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const conversionesData = <?php echo json_encode($conversionesJson, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\20\Desktop\OTROS PROGRAMAS\PROYECTO PARA TECNOWEB\proyecto prueba 1\para software2\proyecto-tecnoweb_restaurante\sistema-web\resources\views/movimientos/create.blade.php ENDPATH**/ ?>