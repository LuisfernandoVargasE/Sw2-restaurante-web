        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="title mb-30">
                    <h2><?php echo e(__('Reportes de Ventas')); ?></h2>
                </div>
            </div>
            <?php
...
[$__name, $__params] = $__split('reportes-guardar');

$__html = app('livewire')->mount($__name, $__params, 'lw-2475846115-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\20\Desktop\OTROS PROGRAMAS\PROYECTO PARA TECNOWEB\proyecto prueba 1\para software2\proyecto-tecnoweb_restaurante\sistema-web\resources\views/reportes/index.blade.php ENDPATH**/ ?>