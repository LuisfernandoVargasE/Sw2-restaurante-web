    ...
    public function predecir()
    {
        ...
        try {
            ...
            if ($response->successful()) {
                ...
                $desperdicio = $data['desperdicio_predicho'];
                ...
                \App\Helpers\HistorialHelper::registrar(
                    'Realizó predicción de desperdicio',
                    'Receta: ' . $nombreReceta . ', Insumo: ' . $nombreInsumo . ', Mes: ' . $this->mes . ', Cantidad: 10, Resultado: ' . $desperdicio . ' ' . $unidad,
                    'Predicciones'
                );
            } else {
                ...
                \App\Helpers\HistorialHelper::registrar(
                    'Error en predicción de desperdicio',
            ...
            // Registrar error en historial
            \App\Helpers\HistorialHelper::registrar(
                'Error de conexión en predicción de desperdicio',
                "Error: " . $e->getMessage(),
                'Predicciones'
            );
        }
    ...
    public function reentrenar()
    {
        try {
            ...
            if ($response->successful()) {
                ...
                // Registrar en historial
                \App\Helpers\HistorialHelper::registrar(
                    'Re-entrenamiento del modelo de desperdicio',
                    'Modelo de predicción de desperdicio re-entrenado exitosamente',
                    'Predicciones'
                );
            } else {
                ...
                // Registrar error en historial
                \App\Helpers\HistorialHelper::registrar(
                    'Error en re-entrenamiento de desperdicio',
            ...
            // Registrar error en historial
            \App\Helpers\HistorialHelper::registrar(
                'Error de conexión en re-entrenamiento de desperdicio',
